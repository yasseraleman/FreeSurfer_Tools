function HTML_File = Create_FreeSurfer_HTML(FreeDir,IdFile);
%
% Syntax :
%   HTML_File = Create_FreeSurfer_HTML(ProjectDir,IdFile);
%
...
HTML_Filep = [FreeDir filesep 'QControl-FS_index.html'];
